  ...
  return (
    <div className="min-h-screen font-sans" style={{ color: colors.text }}>
      ...
      <div className="max-w-6xl px-4 py-12 mx-auto">
        <h1
          className="mb-2 text-3xl font-bold text-center md:text-5xl"
          style={{ color: colors.text, fontSize: 50 }}
        >
          Past Olympiads
        </h1>
        <em>
          <p
            className="mb-12 text-base text-center md:text-lg"
            style={{ color: colors.subtext, marginTop: 20 }}
          >
              ...
              <div className="flex flex-col gap-6 md:gap-8">
                ...
                <div className="w-full">
                  <div className="flex flex-col items-center justify-center gap-2 mb-4 sm:flex-row sm:gap-3">
                    ...
                    />
                    <h2
                      className="text-xl font-bold text-center sm:text-2xl md:text-3xl"
